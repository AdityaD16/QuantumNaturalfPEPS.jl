...
simple_update(peps,ham;iter=100,dt=0.01,su_bdim=nothing,convergence_cutoff = 1e-11,verbose=true,kwargs...) = simple_update!(deepcopy(peps),ham;iter=iter,dt=dt,su_bdim=su_bdim,convergence_cutoff=convergence_cutoff,verbose=verbose, kwargs...)
